    ...
    <div className="mb-2">
      <div className="flex gap-3">
        <div className="flex flex-col gap-2">
          ...
          <p className="py-[0.25rem] max-w-[360px] w-full self-start px-4 rounded-tl-[30px] rounded-br-[30px] rounded-bl-[30px] border-[#7263f3] bg-[#7263f3] text-white shadow-sm">
            {content}
          </p>
        </div>
        <Image
