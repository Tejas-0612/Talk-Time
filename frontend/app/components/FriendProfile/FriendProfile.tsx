  ...
  return (
    <div className="py-4 h-full flex flex-col justify-between">
      <div className="flex flex-col items-center">
        ...
        <h2
          className={`mt-2 px-4 font-bold self-center text-2xl dark:gradient-text dark:text-slate-100`}
        >
          {activeChatData?.name}
        </h2>
        ...
        <p className="mt-6 py-4 w-full border-t-2 border-white self-start flex flex-col dark:border-[#3C3C3C]/60">
          <span
            className={`pl-4 font-medium text-[16px] dark:gradient-text dark:text-slate-200`}
          >
            About
          </span>
